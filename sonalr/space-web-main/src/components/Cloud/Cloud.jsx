...
const Api_key = "d3006d75fbeb578fabcef22182d70f7c";
...
const App = () => {
  ...
  return (
    ...
    <div className="bg-gray-100 min-h-screen flex items-center justify-center px-4">
      <div className="bg-white w-full max-w-md sm:max-w-sm md:max-w-md lg:max-w-lg p-6 rounded-lg shadow-lg">
        <div className=" flex items-center justify-between space-x-2 ">
          ...
          p-1 border-gray-200 font-semibold uppercase flex-1 bg-light"
          />
